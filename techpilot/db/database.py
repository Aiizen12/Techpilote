...
DEFAULT_DB = {
    ...
    "skill_parcours": [
        {
            "id": "sp-01",
            "nom": "Parcours Onboarding N1",
            "description": "Le socle minimum pour un technicien N1 opérationnel en 2 semaines",
            "icon": "map",
            "color": "#6366f1",
            "etapes": [],
        },
        {
            "id": "sp-02",
            "nom": "Spécialiste Téléphonie",
            "description": "Maîtriser la téléphonie IP et mobile pour devenir référent d'équipe",
            "icon": "phone-call",
            "color": "#8b5cf6",
            "etapes": [],
        },
        {
            "id": "sp-03",
            "nom": "Expert Active Directory",
            "description": "Gestion avancée des comptes, groupes et droits dans l'AD",
            "icon": "key-round",
            "color": "#ec4899",
            "etapes": [],
        },
