...
def quete_card(q: QueteItem) -> rx.Component:
    ...
    return rx.box(
        ...
        border_left=rx.match(
            q["difficulte"],
            ("E", "4px solid #6b7280"), ("D", "4px solid #22c55e"),
            ("C", "4px solid #3b82f6"), ("B", "4px solid #a855f7"),
            ("A", "4px solid #f59e0b"), ("S", "4px solid #ef4444"),
            ("SS","4px solid #f97316"),
            "4px solid #6b7280",
        ),
        border_radius="12px",
        ...
        rx.vstack(
            ...
            rx.dialog.root(
                rx.dialog.content(
                    ...
                    rx.vstack(
                        rx.input(placeholder="Titre *", value=QuetesState.create_form["titre"], on_change=lambda v: QuetesState.set_create_field("titre",v), background="#1c2138",style={"color": TEXT},border=f"1px solid {BORDER}",border_radius="8px",width="100%"),
                        rx.text_area(placeholder="Description", value=QuetesState.create_form["description"], on_change=lambda v: QuetesState.set_create_field("description",v), background="#1c2138",style={"color": TEXT},border=f"1px solid {BORDER}",border_radius="8px",width="100%"),
                        rx.hstack(
                            rx.vstack(rx.text("Type",color=MUTED,font_size="0.75rem"), rx.select(["quotidienne","hebdomadaire","achievement"],value=QuetesState.create_form["type"],on_change=lambda v:QuetesState.set_create_field("type",v),background="#1c2138",style={"color": TEXT},border=f"1px solid {BORDER}",border_radius="8px"),spacing="1"),
                            rx.vstack(rx.text("Difficulté",color=MUTED,font_size="0.75rem"), rx.select(["E","D","C","B","A","S","SS"],value=QuetesState.create_form["difficulte"],on_change=lambda v:QuetesState.set_create_field("difficulte",v),background="#1c2138",style={"color": TEXT},border=f"1px solid {BORDER}",border_radius="8px"),spacing="1"),
                            spacing="3",width="100%",
                        ),
                        rx.hstack(
                            rx.vstack(rx.text("XP",color=MUTED,font_size="0.75rem"), rx.input(placeholder="50",value=QuetesState.create_form["xp"],on_change=lambda v:QuetesState.set_create_field("xp",v),type="number",background="#1c2138",style={"color": TEXT},border=f"1px solid {BORDER}",border_radius="8px"),spacing="1"),
                            rx.vstack(rx.text("Objectif",color=MUTED,font_size="0.75rem"), rx.input(placeholder="1",value=QuetesState.create_form["objectif"],on_change=lambda v:QuetesState.set_create_field("objectif",v),type="number",background="#1c2138",style={"color": TEXT},border=f"1px solid {BORDER}",border_radius="8px"),spacing="1"),
                            rx.vstack(rx.text("Unité",color=MUTED,font_size="0.75rem"), rx.input(placeholder="action",value=QuetesState.create_form["unite"],on_change=lambda v:QuetesState.set_create_field("unite",v),background="#1c2138",style={"color": TEXT},border=f"1px solid {BORDER}",border_radius="8px"),spacing="1"),
                            rx.vstack(rx.text("Icône",color=MUTED,font_size="0.75rem"), rx.input(placeholder="🎯",value=QuetesState.create_form["icone"],on_change=lambda v:QuetesState.set_create_field("icone",v),background="#1c2138",style={"color": TEXT},border=f"1px solid {BORDER}",border_radius="8px",width="70px"),spacing="1"),
                            spacing="3",width="100%",
                        ),
                        rx.hstack(
